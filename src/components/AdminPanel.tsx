...
//   const pendingExperiences = experiences.filter(exp => exp.verified === false);
//   const approvedExperiences = experiences.filter(exp => exp.verified === true);
...
//       const updatedRounds = [...editFormData.content];
//       updatedRounds[index] = { ...updatedRounds[index], [field]: value };
//       setEditFormData({ ...editFormData, content: updatedRounds });
//     }
//   };
...
//       setEditFormData({ ...editFormData, tips: updatedTips as string[] });
//     }
//   };

//   const removeTip = (index: number) => {
//     if (editFormData.tips) {
//       const updatedTips = editFormData.tips.filter((_: any, i: number) => i !== index);
//       setEditFormData({ ...editFormData, tips: updatedTips as string[] });  
//     }
//   };
...
//             {experience.content.map((round, index) => (
...
//             onChange={(e) => setFormData({...formData, author: { ...formData.author, name: e.target.value } as User})}
//           />
//         </div>
//         <div>
//           <Label>Department</Label>
//           <Select value={formData.author?.department || ''} onValueChange={(value) => setFormData({...formData, department: value})}>
//             <SelectTrigger>
//               <SelectValue />
//             </SelectTrigger>
//             <SelectContent>
...
//         <div>
//           <Label>Experience Date(Approx)</Label>
//           <Input
//             type="date"
...
//           <Select value={formData.job_type || ''} onValueChange={(value) => setFormData({...formData, job_type: value as "internship" | "fte" | "research" | "other"})}>
//             <SelectTrigger>
//               <SelectValue />
//             </SelectTrigger>
//             <SelectContent>
...
//           {formData.content?.map((round: any, index: number) => (
...
//           {Array.isArray(formData.tips) && formData.tips?.map((tip: string, index: number) => (
